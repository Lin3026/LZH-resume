  ...
  return (
    <section id="projects" className="py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-cyan-400 font-semibold text-lg text-center mb-16">点击卡片查看详情，支持上传本地视频预览</p>

        <div className="grid sm:grid-cols-2 gap-6">
          {projects.map((project) => (
            <div
              key={project.id}
              className="group bg-white/80 border border-blue-200 rounded-2xl overflow-hidden cursor-pointer hover:border-cyan-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-cyan-500/20 shadow-lg ocean-card"
