  ...
  return (
    <section id="education" className="py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <p className="text-cyan-400 font-semibold text-lg text-center mb-16">知识是最好的投资</p>

        <div className="grid md:grid-cols-2 gap-6">
          {educations.map((edu) => (
            <Card
              key={edu.id}
              className="bg-white/80 border-blue-200 hover:border-cyan-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/20 shadow-lg ocean-card"
            >
