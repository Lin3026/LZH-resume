...
const WORKS: {
  ...
  },
  {
    ...
    detail: {
      ...
      projectIntro:
        '游戏：假日乐消消乐，用户人群女性占比较多，核心年龄层 25-35 岁。',
      creativeConcept:
        '以抖音热门语音作口播文案，搭配表情包强化记忆点；开头 3 秒直抓注意力，后续用搞笑对话推进节奏，带动完播与互动。',
      metrics: [
        { label: 'CTR', value: '4.2%' },
        { label: 'CVR', value: '55%' },
        { label: '新增', value: '1800' },
  ...
  },
  {
    ...
    detail: {
      ...
      projectIntro:
        '游戏：假日乐消消乐，用户人群女性占比较多，核心年龄层 25-35 岁。',
      creativeConcept:
        '以「建造」玩法为钩子，强化 ASMR 沉浸感；用 AI 生成建造过程与多视角镜头，既提升视频吸引力，又因内容贴合玩法，精准锁定核心用户。',
      metrics: [
        { label: 'CTR', value: '3.8%' },
        { label: 'CVR', value: '48%' },
        { label: '新增', value: '1200' },
  ...
  },
  {
    ...
    detail: {
      ...
      projectIntro:
        '游戏：假日乐消消乐，用户人群女性占比较多，核心年龄层 25-35 岁。',
      creativeConcept:
        '以抖音热门音乐 + 猫咪跳舞作为钩子，快速抓住注意力；随后衔接游戏各玩法的介绍，层层递进，更快锁定并吸引核心用户。',
      metrics: [
        { label: '播放量', value: '50w+' },
        { label: '互动率', value: '8.2%' },
        { label: '完播率', value: '65%' },
  ...
  },
  {
    ...
    detail: {
      ...
      creativeConcept:
        '以最传统的新老关卡对比唤醒玩家记忆，制造「回忆杀」；随后衔接连续消除的爽感镜头，层层递进，激发用户的尝试欲望。',
      metrics: [
        { label: 'CTR', value: '6.1%' },
        { label: 'CVR', value: '52%' },
        { label: '新增', value: '3500' },
