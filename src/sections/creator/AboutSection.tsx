...
const ABOUT_PARAGRAPHS = [
  '9年视频设计经验，其中7年多游戏创意经验，擅长挖掘产品卖点、分析广告数据、归纳总结优秀案例，并沉淀方法论，将它应用于工作中。',
  '7年游戏消除游戏广告制作和数据分析经验，掌握各地区人群属性、偏好及特点：了解各品类、各平台、各国家地区的素材特点和素材方向。',
  '2年使用 AI 工具（如 ChatGPT、Gemini、即梦、龙虾等）进行创意发散与落地，经验丰富且具备工作流经验。',
];
