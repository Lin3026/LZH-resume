  ...
  return (
    <section id="work-content" className="py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <p className="text-cyan-400 font-semibold text-lg text-center mb-16">实践是最好的老师</p>

        <div className="bg-white/80 border border-blue-200 rounded-2xl p-6 md:p-12 shadow-xl ocean-card">
